       ...
       <div class="row">
        <div class="col-lg-8">
            <h3 class="page-title mb-4">
                ...
                </span> Add Promo Terbaru
            </h3>
                <form method="post" action="/dashboard/promo" enctype="multipart/form-data">
                    @csrf
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control @error('promo') is-invalid @enderror" name="promo" id="promo" placeholder="name@example.com" required onfocus="" value="{{ old('promo') }}">
                    ...
                    @enderror
                      ...
                      <button type="submit" name="submit" class="btn-tambah bg-gradient-primary">Tambah Promo</button>
                </form>
        </div>
       </div>
    </div>

       ...
       <div class="row">
        <div class="col-lg-8">
            <h3 class="page-title mb-4">
                ...
                <form method="post" action="/dashboard/peopleSay" enctype="multipart/form-data">
                    @csrf
                    ...
                    @enderror
                      ...
                      <button type="submit" name="submit" class="btn-tambah bg-gradient-primary">Tambah Komentar</button>
                </form>
        </div>
       </div>
    </div>

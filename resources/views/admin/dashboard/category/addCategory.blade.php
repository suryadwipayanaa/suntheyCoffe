            ...
            <h3 class="page-title mb-4">
                ...
                <form method="post" action="/dashboard/category" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control @error('category') is-invalid @enderror" name="category" id="category" placeholder="name@example.com" required onfocus="" value="{{ old('category') }}">
                    ...
                    @enderror
                      ...
                      <button type="submit" name="submit" class="btn-tambah bg-gradient-primary">Tambah Category</button>
                </form>
        </div>
       </div>
    </div>

       ...
       <div class="row">
        <div class="col-lg-8">
            <h3 class="page-title mb-4">
                ...
                <form method="post" action="/dashboard/allProduk/{{ $produk->slug }}" enctype="multipart/form-data">
                  @method('put')
                    @csrf
                    <input type="hidden" name="oldImage" value="{{ $produk->image }}">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" id="nama" placeholder="name@example.com" required onfocus="" value="{{ old('nama', $produk->nama) }}">
                    ...
                    @enderror
                      ...
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" placeholder="slug" required value="{{ old('slug', $produk->slug) }}">
                      ...
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control @error('harga') is-invalid @enderror" name="harga"  placeholder="name@example.com" required onfocus="" value="{{ old('harga', $produk->harga) }}">
                        ...
                        @if($produk->image)
                          <div class="row">
                            <div class="col-sm-12 col-md-6">
                              <img id="imagePreview" src="{{ url('storage/'.$produk->image) }}" class="img-fluid">
                            </div>
                          </div>
                        @endif
